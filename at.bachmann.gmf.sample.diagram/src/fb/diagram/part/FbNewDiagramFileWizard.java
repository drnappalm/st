 ...
 * @generated
 */
public class FbNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public FbNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot,
		...
		myFileCreationPage = new WizardNewFileCreationPage(
				Messages.FbNewDiagramFileWizard_CreationPageName,
		...
		diagramRootElementSelectionPage
				.setTitle(Messages.FbNewDiagramFileWizard_RootSelectionPageTitle);
		diagramRootElementSelectionPage
				.setDescription(Messages.FbNewDiagramFileWizard_RootSelectionPageDescription);
	...
	public boolean performFinish() {
		...
		FbDiagramEditorUtil.setCharset(diagramFile);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				myEditingDomain,
				Messages.FbNewDiagramFileWizard_InitDiagramCommand,
				affectedFiles) {
		...
		try {
			...
			diagramResource.save(FbDiagramEditorUtil.getSaveOptions());
			FbDiagramEditorUtil.openDiagram(diagramResource);
	...
	private static class DiagramRootElementSelectionPage extends
		...
		protected String getSelectionTitle() {
			return Messages.FbNewDiagramFileWizard_RootSelectionPageSelectionTitle;
		}
		...
		protected boolean validatePage() {
			if (getModelElement() == null) {
				setErrorMessage(Messages.FbNewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
