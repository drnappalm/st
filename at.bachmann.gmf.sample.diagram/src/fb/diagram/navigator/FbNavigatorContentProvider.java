 ...
 * @generated
 */
public class FbNavigatorContentProvider implements ICommonContentProvider {
	...
	public FbNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<FbNavigatorItem> result = new ArrayList<FbNavigatorItem>();
		...
		if (parentElement instanceof FbNavigatorGroup) {
			FbNavigatorGroup group = (FbNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof FbNavigatorItem) {
			FbNavigatorItem navigatorItem = (FbNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case VariableEditPart.VISUAL_ID: {
			...
			FbNavigatorGroup incominglinks = new FbNavigatorGroup(
					Messages.NavigatorGroupName_Variable_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			FbNavigatorGroup outgoinglinks = new FbNavigatorGroup(
					Messages.NavigatorGroupName_Variable_2002_outgoinglinks,
	 ...
	 * @generated
	 */
	private Collection<FbNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<FbNavigatorItem> result = new ArrayList<FbNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new FbNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof FbAbstractNavigatorItem) {
			FbAbstractNavigatorItem abstractNavigatorItem = (FbAbstractNavigatorItem) element;
