 ...
 * @generated
 */
public class FbViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return FBDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& FbVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = FbVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = FbVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!FbElementTypes.isKnownElementType(elementType)
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = FbVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != FbVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(FBDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = FbVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = FbVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case FBEditPart.VISUAL_ID:
		...
		case OUTVariableEditPart.VISUAL_ID:
			return createOUTVariable_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case INVariableEditPart.VISUAL_ID:
			return createINVariable_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (FbVisualIDRegistry.getVisualID(elementTypeHint)) {
	 ...
	 * @generated
	 */
	public Node createFB_2001(EObject domainElement, View containerView,
		...
		node.setType(FbVisualIDRegistry.getType(FBEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createOUTVariable_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FbVisualIDRegistry.getType(OUTVariableEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createINVariable_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FbVisualIDRegistry.getType(INVariableEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createConnection_4001(EObject domainElement,
		...
		edge.setType(FbVisualIDRegistry.getType(ConnectionEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!FBDiagramEditPart.MODEL_ID.equals(FbVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", FBDiagramEditPart.MODEL_ID); //$NON-NLS-1$
