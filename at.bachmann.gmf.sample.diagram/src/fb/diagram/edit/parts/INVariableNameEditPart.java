 ...
 * @generated
 */
public class INVariableNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public INVariableNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = FbParserProvider
					.getParser(
							...
							getParserElement(),
							FbVisualIDRegistry
									.getType(fb.diagram.edit.parts.INVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
