...
import fb.diagram.edit.policies.OUTVariableItemSemanticEditPolicy;
import fb.diagram.part.FbVisualIDRegistry;

/**
 * @generated
 */
public class OUTVariableEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public OUTVariableEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OUTVariableItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OUTVariableNameEditPart) {
			((OUTVariableNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureVariableNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(FbVisualIDRegistry
				.getType(OUTVariableNameEditPart.VISUAL_ID));
	}
