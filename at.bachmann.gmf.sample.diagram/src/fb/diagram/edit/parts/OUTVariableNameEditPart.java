 ...
 * @generated
 */
public class OUTVariableNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OUTVariableNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return FbElementTypes.getImage(parserElement.eClass());
	}
		...
		if (parser == null) {
			parser = FbParserProvider
					.getParser(
							...
							getParserElement(),
							FbVisualIDRegistry
									.getType(fb.diagram.edit.parts.OUTVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
