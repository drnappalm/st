...
/**
 * This is the item provider adapter for a {@link fb.FB} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FBItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FB_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FB_name_feature", "_UI_FB_type"),
				 FbPackage.Literals.FB__NAME,
				 true,
				 false,
				 false,
	...
	protected void addXPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FB_x_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FB_x_feature", "_UI_FB_type"),
				 FbPackage.Literals.FB__X,
				 true,
				 false,
				 false,
	...
	protected void addYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FB_y_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FB_y_feature", "_UI_FB_type"),
				 FbPackage.Literals.FB__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FB"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FB_type") :
			getString("_UI_FB_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FB.class)) {
