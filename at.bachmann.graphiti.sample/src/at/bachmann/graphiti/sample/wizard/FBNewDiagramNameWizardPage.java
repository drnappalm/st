...
public class FBNewDiagramNameWizardPage extends AbstractWizardPage {

	private static final String PAGE_DESC = "Create a new FB Diagram using Graphiti";
	private static final String PAGE_TITLE = "New FB Diagram";
	...
	public FBNewDiagramNameWizardPage(String pageName, String title,
			ImageDescriptor titleImage) {
		super(pageName, title, titleImage);
	}

	protected FBNewDiagramNameWizardPage(String pageName) {
		super(pageName);
		setTitle(PAGE_TITLE);
