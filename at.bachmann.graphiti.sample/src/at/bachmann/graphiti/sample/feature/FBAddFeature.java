...
public class FBAddFeature extends AbstractAddShapeFeature {
	...
	public FBAddFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		FB addedClass = (FB) context.getNewObject();
		...
		int height = Constants.SHAPE_HEIGTH;
		 ...
		 * LAYOUT (more or less) so ignore the x value
		 */
