...
public class VariableUpdateFeature extends DefaultUpdateDiagramFeature implements
		IUpdateFeature {

	public VariableUpdateFeature(IFeatureProvider fp) {
		super(fp);
	}
	
	@Override
	public boolean canUpdate(IUpdateContext context) {
		return getBusinessObjectForPictogramElement(context.getPictogramElement()) instanceof Variable;
	}
	
	@Override
	public IReason updateNeeded(IUpdateContext context) {
		Variable businessObject = (Variable) getBusinessObjectForPictogramElement(context.getPictogramElement());
