...
public class VariableLayoutFeature extends AbstractLayoutFeature implements
		ILayoutFeature {

	public VariableLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		Object businessObject = getBusinessObjectForPictogramElement(context
				.getPictogramElement());
		return businessObject != null && businessObject instanceof Variable;
	}
	...
	public boolean layout(ILayoutContext context) {
		 ...
		 */
		if (containerGa.getHeight() != Constants.SHAPE_HEIGTH_VARIABLE) {
			containerGa.setHeight(Constants.SHAPE_HEIGTH_VARIABLE);
			layouted = true;
		}
